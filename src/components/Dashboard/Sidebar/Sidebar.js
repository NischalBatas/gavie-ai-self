...
const menulist1=[
    {title:'Overview', pathname:'/dashboard', url:'/', image:'/Image/dashboard/7.svg'},
    {title:'Agent', pathname:'/agent', url:'/', image:'/Image/dashboard/1.svg'},
    {title:'Knowledge Base', pathname:'/knowledge-base', url:'/', image:'/Image/dashboard/2.svg'},
    {title:'Journeys', pathname:'/journeys', url:'/', image:'/Image/dashboard/3.svg'},
    {title:'Automations', pathname:'/automations', url:'/', image:'/Image/dashboard/4.svg'},
    {title:'Integrations', pathname:'/integrations', url:'/', image:'/Image/dashboard/5.svg'},
    {title:'Monitoring', pathname:'/monitoring', url:'/', image:'/Image/dashboard/6.svg'},
]

const menulist2=[
    {title:'Sales',chat_inbox:120, pathname:'/sales', url:'/', image:'/Image/chat/c1.jpg'},
    {title:'Marketing', chat_inbox:10, pathname:'/marketing', url:'/', image:'/Image/chat/c2.jpg'},
    {title:'Call Center', chat_inbox:80, pathname:'/call-center', url:'/', image:'/Image/chat/c3.jpg'},
    {title:'Error Handling', chat_inbox:50, pathname:'/error-handling', url:'/', image:'/Image/chat/c4.jpg'}
]
...
"box-shadow": "0px -1px 0px 0px #292932 inset"
        ...
        <div className='inline-flex items-center w-full  gap-x-2.5 rounded-[15px] px-3 py-2 text-sm font-semibold bg-[#292932] shadow-sm ring-1 ring-inset ring-[#44444F]'>
            <Image width={36} height={36} src='/Image/dashboard/dai.png' alt='user profile'/>
