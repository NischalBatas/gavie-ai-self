    ...
    <div className="flex flex-col gap-5 rounded-[20px] bg-[#1C1C24] p-5">
      ...
      <div className="flex justify-between flex-wrap gap-3 gap-y-6 mt-6">
        <div className="flex gap-3 items-center">
          <Image width={70} height={70} src="/Image/dashboard/8.svg" />
          <div className="flex flex-col">
        ...
        <div className="flex gap-3 items-center">
          <Image width={70} height={70} src="/Image/dashboard/9.svg" />
          <div className="flex flex-col">
        ...
        <div className="flex gap-3 items-center">
          <Image width={70} height={70} src="/Image/dashboard/10.svg" />
          <div className="flex flex-col">
